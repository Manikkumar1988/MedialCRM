...
public class ProductsRemoteDataSource implements ProductsDatasource {
  ...
  private final static Map<String, Product> PRODUCTS_SERVICE_DATA = new LinkedHashMap<>(6);
  ...
  @Override public void addProduct(@NonNull Product productToBeAdded) {
    ProductsRemoteDataSource.addProduct(productToBeAdded.getName(),productToBeAdded.getCategoryId(),productToBeAdded.getImageUrl(),
        UUID.randomUUID().toString(), productToBeAdded.getPrice());
  }
