...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
  ...
  @BindView(R.id.sale_task_master) ViewPager salesTaskMasterViewPager;
  ...
  private void setupViewPager() {
    salesTaskMasterViewPager.setAdapter(new HomePageAdapter(getSupportFragmentManager()));
  }
  ...
  @SuppressWarnings("StatementWithEmptyBody") @Override public boolean onNavigationItemSelected(MenuItem item) {
    ...
    if (id == R.id.add_tasks) {
      ...
      startActivity(new Intent(getApplicationContext(), TaskCreateActivity.class));
    } else if (id == R.id.add_sales_rep) {
      startActivity(new Intent(getApplicationContext(), SalesCreateActivity.class));
    }
    DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
    drawer.closeDrawer(GravityCompat.START);
    return true;
