...
public class PlaceAutocompleteAdapter
    ...
    private ArrayList<AutocompletePrediction> getAutocomplete(CharSequence constraint) {
        Util.Logger(TAG, "Starting autocomplete query for: " + constraint);
        ...
        try {
            ...
            Util.Logger(TAG, "Query completed. Received " + autocompletePredictions.getCount()
                    + " predictions.");
            ...
            Util.Logger(TAG, "Error getting autocomplete prediction API call");
